...
class Game:
    ...
    def get_new_direction_from_prediction(prediction, current_direction):
        ...
        # Handle new direction while prediction is "KEEP DIRECTION".
        if prediction == Prediction.KEEP_DIRECTION and current_direction == Direction.LEFT:
            return Direction.LEFT

        if prediction == Prediction.KEEP_DIRECTION and current_direction == Direction.RIGHT:
            return Direction.RIGHT

        if prediction == Prediction.KEEP_DIRECTION and current_direction == Direction.UP:
            return Direction.UP

        if prediction == Prediction.KEEP_DIRECTION and current_direction == Direction.DOWN:
            return Direction.DOWN

        # Handle new direction while prediction is "ROTATE LEFT"
        if prediction == Prediction.ROTATE_LEFT and current_direction == Direction.LEFT:
            return Direction.DOWN

        if prediction == Prediction.ROTATE_LEFT and current_direction == Direction.RIGHT:
            return Direction.UP

        if prediction == Prediction.ROTATE_LEFT and current_direction == Direction.UP:
            return Direction.LEFT

        if prediction == Prediction.ROTATE_LEFT and current_direction == Direction.DOWN:
            return Direction.RIGHT

        # Handle new direction while prediction is "ROTATE RIGHT"
        if prediction == Prediction.ROTATE_RIGHT and current_direction == Direction.LEFT:
            return Direction.UP

        if prediction == Prediction.ROTATE_RIGHT and current_direction == Direction.RIGHT:
            return Direction.DOWN

        if prediction == Prediction.ROTATE_RIGHT and current_direction == Direction.UP:
            return Direction.RIGHT

        if prediction == Prediction.ROTATE_RIGHT and current_direction == Direction.DOWN:
            return Direction.DOWN
